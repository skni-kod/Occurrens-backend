...
namespace Occurrens.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartamentNumber = table.Column<int>(type: "integer", nullable: true),
                    ...
                    LastUpdateBy = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorWorkPlaces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorWorkPlaces_AspNetUsers_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorWorkPlaces_AccountId",
